...
## Terminal Colors
#! no place but used by tmux and awesome #202a34
background  = '#20252c'
color0      = '#222c36'
...
## Type: QssColor
c.colors.statusbar.command.bg = color13
...
## (http).
## Type: QssColor
c.colors.statusbar.url.success.http.fg = '#e0f7fa'

## Foreground color of the URL in the statusbar on successful load
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = '#e0f7fa' 
...
## Type: Font
# c.fonts.monospace = '"Iosevka Term", "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
## Type: QtFont
c.fonts.tabs = '11pt Iosevka Term'
...
## Type: Padding
c.tabs.padding = {'top': 3, 'bottom': 0, 'left': 5, 'right': 5}
